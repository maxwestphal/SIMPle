#  Slighty modified pairs version for SIMPle package.
#  Only the axis ticks are drawn differently, otherwise equal to original, see below.
...
pairs2 <- function(x, ...) UseMethod("pairs2")
